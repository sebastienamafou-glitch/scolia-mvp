  ...
  return (
    <div style={{ fontFamily: '"Inter", sans-serif', color: '#333', overflowX: 'hidden' }}>
      ...
      <header style={{ 
          ...
          textAlign: 'center',
          backgroundImage: 'radial-gradient(circle at 10% 20%, rgba(247, 127, 0, 0.1) 0%, transparent 20%)' // Touche subtile d'orange
      }}>
      ...
      <section id="features" style={{ padding: '80px 5%', maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px' }}>
              <FeatureCard 
                  ...
                  color="#008F39" // Vert Mobile Money
      ...
      <footer style={{ backgroundColor: '#f8f9fa', padding: '40px 5%', borderTop: '1px solid #e0e0e0', textAlign: 'center', color: '#666' }}>
          ...
          <p style={{ marginTop: '20px' }}>&copy; 2025 Scolia. Tous droits réservés.</p>
